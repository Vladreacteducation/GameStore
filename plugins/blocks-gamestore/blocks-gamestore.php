...
function create_block_blocks_gamestore_block_init() {
    ...
    register_block_type( __DIR__ . '/build/block-info-section');   # реєстрація info-section блоку
    ...
    register_block_type( __DIR__ . '/build/block-playstation-category',array(
        'render_callback' => 'view_block_playstation_category_block'
    )); # block playstation category block  

    register_block_type( __DIR__ . '/build/block-404-template'); # block 404 template
