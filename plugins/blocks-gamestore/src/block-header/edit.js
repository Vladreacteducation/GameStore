...
export default function Edit( { attributes, setAttributes } ) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title="Header Link">
					<TextControl
						label="Member Link"
						value={ memberLink }
						onChange={ ( memberLink ) =>
							setAttributes( { memberLink } )
						}
					/>
					<TextControl
						label="Cart Link"
  ...
  <path d="M21 24C24.3137 24 27 21.3137 27 18C27 14.6863 24.3137 12 21 12C17.6863 12 15 14.6863 15 18C15 21.3137 17.6863 24 21 24Z" stroke="var(--action-main-svg,  rgb(255, 255, 255))" stroke-opacity="0.64" stroke-linecap="round" stroke-linejoin="round" />
						...
						{ cartLink && (
							<div className="header-cart-link">
								<a href={ cartLink }><svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
